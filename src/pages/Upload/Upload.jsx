                    ...
                    <div className={`${styles.pricingContent} customScroll`}>
                      <div className={styles.pricingCard}>
                        <p className={styles.pricingText}>
                          Access the app by paying a one-time fee of $5 for a 20
                          min interview
                        </p>
                      </div>
                      <PaymentBox
                ...
                <div className={styles.paymentPopup}>
                  ...
                  <div className={`${styles.rulesContent} customScroll`}>
                    <ol className={styles.rulesList}>
                      <li>
                        * If you quit the interview prematurely before the time
                        is up, you will be graded up to the completion and
                        feedback will be based on that.
                      </li>
                      <li>
                        * This is a real-time voice AI platform, so you simply
                        have to have a conversation. Press "Start Conversation"
                        when you are ready.
                      </li>
                      <li>
                        * It will take up to ~10 secs for the AI interviewer to
                        connect with you upon pressing "Start Conversation".
                      </li>
                      <li>
                        * Wait if the interviewer is taking some time (couple of
                        seconds) to respond. This is normal.
                      </li>
                      <li>
                        * If you want to change the default audio device, use
                        the dropdown next to the mic.
                      </li>
                    </ol>
